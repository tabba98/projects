...
class Config:
    ...
    def __init__(self):
        ...
        self.move_sound = Sound(
            os.path.join('C:/Users/jacop/Prove/projects/complete_chess/assets/sounds/move.wav'))
        self.capture_sound = Sound(
            os.path.join('C:/Users/jacop/Prove/projects/complete_chess/assets/sounds/capture.wav'))
